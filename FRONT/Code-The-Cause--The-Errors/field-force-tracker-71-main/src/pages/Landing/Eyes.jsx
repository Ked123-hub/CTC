    ...
    return (
        <div className="eyes w-full h-[70vh] md:h-screen overflow-hidden">
            <div data-scroll data-scroll-section data-scroll-speed="-.7" className='relative w-full h-full bg-cover bg-center bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")]'>
                <div data-scroll data-scroll-section data-scroll-speed="0.1" className="flex gap-10 absolute top-1/2 left-[15%] md:left-[20%] -translate-y-[50%]">
                    <div className="flex items-center justify-center w-[35vw] h-[35vw] md:w-[15vw] md:h-[15vw] rounded-full bg-white transition-all duration-300">
                        <div
                            ref={leftEyeRef}
                    ...
                    <div className="flex items-center justify-center w-[35vw] h-[35vw] md:w-[15vw] md:h-[15vw] rounded-full bg-white">
                        <div
                            ref={rightEyeRef}
